				...
				<div class="panel-body">
					<form action="" method="post">
						<div class="form-group">
							...
							<input type="email" class="form-control" name="email" id="eid" placeholder="abc_2101CS01@iitp.ac.in" required />
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div style="align-items: center;padding-left: 3%;">
								...
								No credentials yet? <a href="http://localhost/miniproj/register.php">Register</a>
							</div>
						</div>
					</form>
				</div>
